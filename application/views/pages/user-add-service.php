							...
							<div class="content-main">
								<div class="padding">
									...
									<section class="content-section content-section-page-title">
										<div class="padding">
											<h3 class="page-title">Create Service (Camera Crew)</h3>
										</div><!-- /padding -->
											...
											<div class="padding">
												<div class="content-login-wrapper">
													...
													<div class="content-login-message">
														...
														<div class="form-item">
															<label for="fname">Telephone/ Mobile No<span class="required-field">*</span></label>
														...
														<div class="form-item">
															<label for="company-name">Services: (no more than 20 words)<span class="required-field">*</span></label>
															<textarea class="form-element" name="companyname" id="company-name" required placeholder=""></textarea>
