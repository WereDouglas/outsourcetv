                ...
                <div class="accordion-group">
                    <div class="accordion-body collapse" id="collapseTwo">
                        <div class="accordion-inner">
                            ...
                            <form id="station-form" name="station-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/admin/service/create'  method="post">            
                                <fieldset>
                                    <div class="span4">
    ...
    $(document).ready(function ()
    {
        ...
        }).change(function ()
        {
            ...
            if (name.length > 0 )
            {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() . "index.php/admin/service/update/"; ?>",
                    data: dataString,
                    cache: false,
